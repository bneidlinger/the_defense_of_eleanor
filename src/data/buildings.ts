...
// Behaviour category. Drives how a finished building acts each tick.
export type BuildKind = "wall" | "tower" | "stockpile";
...
export const BUILDABLES: BuildingDef[] = [BUILD_DEFS.palisade, BUILD_DEFS.watchtower];
